...
namespace ChuongTrinhDiemDanh_DHThaiNguyen.RJControls
{
    class CircularPictureBox : PictureBox
    {
        ...
        {
            base.OnResize(e);
            //this.Size = new Size(this.Width, (int)(this.Width*4/3));
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            using (var penBorder = new Pen(borderGColor, borderSize))
            {
                ...
                //this.Region = new Region(pathRegion);
                ////Drawing
                //graph.DrawRectangle(penSmooth, rectContourSmooth);//Draw contour smoothing
                //if (borderSize > 0) //Draw border
